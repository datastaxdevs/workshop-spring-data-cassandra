...
@Repository
public class TodoRepositoryCassandra extends SimpleCassandraRepository<TodoEntity, UUID> {
    ...
    public TodoRepositoryCassandra(CqlSession cqlSession, CassandraOperations ops) {
